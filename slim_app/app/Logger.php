...
class Logger
{
    ...
    public static function createLogFile()
    {
        ...
        static::$log_file =  static::$options['logPath'] . "/log-{$time}.txt";


        //Check if directory /logs exists
        if (!file_exists(static::$options['logPath'])) {
            mkdir(static::$options['logPath'], 0777, true);
        }
        ...
        if (!is_writable(static::$log_file)) {
            ...
            throw new Exception("ERROR: Unable to write to log file!", 1);
        }
    }
