...
var Radio = function(stations) {
  ...
  for (var i=0; i<self.stations.length; i++) {
    ...
    window['title' + i].setAttribute('title', self.stations[i].descr);
...
var radio = new Radio([
  {
    title: 'Ambient Radio',
    descr: 'Beautiful Chillout Music',
    src: 'http://uk2.internet-radio.com:8171/stream',
    howl: null
  },
  {
    title: 'Dubstep.fm',
    descr: 'Dubstep Internet Radio',
    src: 'http://stream.dubstep.fm/128mp3',
    howl: null
  },
  {
    title: 'Hip Hop Hits',
